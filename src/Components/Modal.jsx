  ...
  return (
    ...
    <Modal show={show} animation={false} centered onHide={handleClose} >
        ...
        <Modal.Body>
          ...
          <ButtonTag label={'Sign in to see your addresses'} className={'w-100 bg-warning border-0 text-dark'}/>
          <hr />
          <div className='d-flex flex-row align-items-center justify-content-center gap-2'>
          <InputBox className={'w-100 border-dark'}/>
          <ButtonTag label={'Apply'} variant={'outline-light'} className={'text-dark'}/>
          </div>
        </Modal.Body>
      </Modal>
    </>
