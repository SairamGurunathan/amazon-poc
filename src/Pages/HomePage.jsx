...
import { additionalProducts } from "../Constant/AdditionalProducts";
...
const HomePage = () => {
  ...
  return (
    <>
      <div className="under">
        <CoverImageSlide imageList={coverImage} onClick={()=>navigate('/results')}/>
      </div>
      <div className="over">
          ...
          <div className="card my-4 overflow-auto slide-card">
            <Col lg={12} className="p-3">
              <div className="d-flex flex-row align-items-center">
                ...
                <Link className="text-decoration-none ps-3">
                  <small className="fs-14 card-link link-hover">
                    Explore more
                  </small>
                </Link>
              </div>
          ...
          <div className="card my-4 overflow-auto slide-card">
            <Col lg={12} className="p-2">
              <div className="d-flex flex-row align-items-center">
                ...
                <Link className="text-decoration-none ps-3">
                  <small className="fs-14">Explore more</small>
                </Link>
              </div>
              <SlideSHowList
                imageList={toysImage}
        ...
        <Row className="mx-3 g-3">
          {additionalProducts?.map((pro, index) => (
            <Col lg={3} key={index}>
              <ProductCard
                heading={pro?.heading}
                img={pro?.img}
